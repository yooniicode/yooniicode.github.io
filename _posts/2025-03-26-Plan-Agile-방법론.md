...
- principles
  ...
  1. Being open to changing requirements in the stages of the development.
  1. Frequently delivering working software with a main focus on preference for timeframes.
  1. Promoting collaboration between business stakeholders and developers as an element.
  1. Structuring the projects around individuals. Providing them with the necessary environment and support.
  1. Prioritizing face to face communication whenever needed.
  1. Considering working software as the measure of the progress.
  1. Fostering development by allowing teams to maintain a pace indefinitely.
  1. Placing attention on excellence and good design practices.
  1. Recognizing the simplicity as crucial factor aiming to maximize productivity by minimizing the work.
  1. Encouraging self organizing teams as the approach to design and build systems.
  1. Regularly reflecting on how to enhance effectiveness and to make adjustments accordingly.

[https://www.geeksforgeeks.org/software-engineering-agile-software-development/](https://www.geeksforgeeks.org/software-engineering-agile-software-development/)
