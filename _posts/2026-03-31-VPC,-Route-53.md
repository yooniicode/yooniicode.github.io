...
categories: [AWS]
tags: [AWS, AWS Cloud Club, VPC, Route 53]
author: yoonji
layout: single
assets: 2026-03-31-vpc-route53
published: true
---
...
{% include post-image.html src="instance.png" width="2486" height="474"
   alt="각 서브넷에 배치한 EC2 인스턴스 목록 콘솔 화면" %}

{% include post-image.html src="routing-table.png" width="2496" height="402"
   alt="퍼블릭/프라이빗 서브넷에 연결된 라우팅 테이블 콘솔 화면" %}
